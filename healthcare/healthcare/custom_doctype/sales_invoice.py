...
class HealthcareSalesInvoice(SalesInvoice):
	...
	def set_healthcare_services(self, checked_values):
		...
		for checked_item in checked_values:
			...
			if checked_item["dt"] == "Xray":
				xray = frappe.get_doc("Xray", checked_item["dn"])
				item_line.service_unit = xray.service_unit
				item_line.practitioner = xray.practitioner
				item_line.medical_department = xray.department
